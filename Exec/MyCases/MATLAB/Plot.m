...
% Efieldy
file3 = strcat(main_folder,EF{1,1},'.mat');
C = zeros(size(importdata(file3),1),size(importdata(file3),2));
C(:,:) = importdata(file3);


% Ionflux
file4 = strcat(main_folder,EF{1,2},'.mat');
